...
import { PORT, DB_NAME, MAP_FRONTEND_PROT, GAME_ENGINE_PORT, WEBSITE_FRONTEND_PORT } from './config'
...
const corsOptions = {
    origin: [`http://localhost:${MAP_FRONTEND_PROT}`, `http://localhost:${GAME_ENGINE_PORT}`, `http://localhost:${WEBSITE_FRONTEND_PORT}`],
