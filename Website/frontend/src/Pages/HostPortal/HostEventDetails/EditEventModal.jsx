 ...
 *
 * Modal dialog component for editing existing event details by event hosts.
 * Provides a form interface for updating event information with validation and error handling.
 *
 * Key Features:
 * - Modal-based event editing interface
 * - Form validation for event data
 * - Date and time input handling
 * - Event type selection (public/private)
 * - Real-time error display and feedback
 * - Loading states during API requests
 * - Success notifications on completion
 *
 * Props:
 * - setPopup: Function to display success/error notifications
 * - event: Current event object with existing data
 * - updatEventDetails: Callback to refresh event data after update
 *
 * Usage: Triggered from host event details page to modify event settings
 */
